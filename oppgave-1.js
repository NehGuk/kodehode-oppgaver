...
let age = 76
const iq = 160
const hobbies = ["physics", "music", "philosophy", "walking", "sailing"]
let isRetired = true
...
const energy = mass * lightSpeed ** 2
const reducedRadius = radius--
const augmentedRadius = radius++
...
console.log("Yoohoooo, that works!")
